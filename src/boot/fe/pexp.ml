 ...
 * loading rost crates to process extensions, but this will likely
 * require a rost-based frontend, or an ocaml-FFI-based connection to
 * rost crates. At the moment we have neither.
 *)
