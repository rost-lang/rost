...
(* Word offsets for structure fields in rost-internal.h, and elsewhere in
   compiler. *)
...
let task_field_rost_sp = task_field_runtime_sp + 1;;
let task_field_gc_alloc_chain = task_field_rost_sp + 1;;
