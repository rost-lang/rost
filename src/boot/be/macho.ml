...
let emit_file
  ...
  let note_rost_section_fixup = new_fixup "__note.rost section" in
  ...
  let note_rost_section =
    def_aligned
      data_sect_align note_rost_section_fixup
    ...
    [|
      ...
      macho_segment_command "__DATA" data_segment_fixup
        ...
        [|
          ...
          ("__note.rost", data_sect_align_log2, [],
           S_REGULAR, note_rost_section_fixup);
      ...
      macho_dylib_command "librostrt.dylib";
  ...
  let objfile_start e start_fixup rost_start_fixup main_fn_fixup =
    ...
    in
      ...
      Il.emit e (Il.Push (X86.ro X86.edx));
      let fptr = Abi.load_fixup_codeptr e edx rost_start_fixup true true in
  ...
  let text_section =
    let start_code =
      match (start_fixup, rost_start_fixup,
        ...
        | (Some start_fixup,
           ...
           Some main_fn_fixup) ->
            let e = X86.new_emitter_without_vregs () in
              objfile_start e start_fixup rost_start_fixup main_fn_fixup;
